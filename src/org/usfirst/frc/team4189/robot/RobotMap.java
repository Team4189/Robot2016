...
public class RobotMap {
	...
	public static int scissorPort = 5; //CHANGE TO 3 OR I WILL TAKE YOU OUT BACK AND SHOOT YOU LIKE A HORSE WITH A BROKEN LEG
	public static int chevalPort = 4;
	public static int shooterAnglePort = 3; //CHANGE TO 5 OR I WILL TAKE YOU OUT BACK AND SHOOT YOU LIKE A HORSE WITH A BROKEN LEG
